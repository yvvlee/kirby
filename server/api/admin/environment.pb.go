...
func (x *EnvironmentIDRequest) Reset() {
	*x = EnvironmentIDRequest{}
	mi := &file_admin_environment_proto_msgTypes[0]
...
func (*EnvironmentIDRequest) Descriptor() ([]byte, []int) {
	return file_admin_environment_proto_rawDescGZIP(), []int{0}
}
...
type EnvironmentReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Environment   *common.Environment    `protobuf:"bytes,1,opt,name=environment,proto3" json:"environment,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListEnvironmentsReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          []*common.Environment  `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListEnvironmentUsersReply struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	List          []*common.EnvironmentMember `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var File_admin_environment_proto protoreflect.FileDescriptor

const file_admin_environment_proto_rawDesc = "" +
	"\n" +
...
var (
	file_admin_environment_proto_rawDescOnce sync.Once
	file_admin_environment_proto_rawDescData []byte
)

func file_admin_environment_proto_rawDescGZIP() []byte {
	file_admin_environment_proto_rawDescOnce.Do(func() {
		file_admin_environment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_admin_environment_proto_rawDesc), len(file_admin_environment_proto_rawDesc)))
	})
...
func init() { file_admin_environment_proto_init() }
func file_admin_environment_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_admin_environment_proto_goTypes,
		DependencyIndexes: file_admin_environment_proto_depIdxs,
		MessageInfos:      file_admin_environment_proto_msgTypes,
	}.Build()
	File_admin_environment_proto = out.File
	file_admin_environment_proto_goTypes = nil
	file_admin_environment_proto_depIdxs = nil
}
