...
describe('system administration API contracts', () => {
  it('maps global user operations to fixed public endpoints', async () => {
    await createUser({
      username: 'alice',
      display_name: 'Alice',
  ...
  it('uses explicit environment IDs for member role assignment', async () => {
  ...
  it('loads permissions from the server and submits only selected IDs', async () => {
  ...
  it('rejects invalid IDs before an HTTP request is sent', async () => {
