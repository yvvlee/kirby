...
describe('environment business API contracts', () => {
  it.each([
    ...
    ['list models', () => listModels(12, { project_id: 2, config_id: 3 }), 'structure/list', { project_id: 2, config_id: 3 }],
    ...
    ['list enums', () => listEnums(12, { project_id: 2, config_id: 3 }), 'enum/list', { project_id: 2, config_id: 3 }],
    ['delete enum', () => deleteEnum(12, 5), 'enum/delete', { id: 5 }],
    ['create snapshot', () => createSnapshot(12, { project_id: 2, config_id: 3 }), 'snapshot/create', { project_id: 2, config_id: 3 }],
    ...
    ['list snapshots', () => listSnapshots(12, { project_id: 2, config_id: 3 }), 'snapshot/list', { project_id: 2, config_id: 3 }],
  ])('%s maps directly to the protobuf HTTP path', async (_name, request, suffix, body) => {
  ...
  it('rejects an invalid explicit environment before sending a request', async () => {
  ...
  it('preserves standard status and structured business error fields', async () => {
    const error = Object.assign(new Error('conflict'), {
      response: {
        status: 409,
        data: {
          code: 409,
          reason: 'NONE_RECORD_UPDATED',
    ...
    await expect(updateProject(12, { id: 2, version: 1 })).rejects.toBe(error)
